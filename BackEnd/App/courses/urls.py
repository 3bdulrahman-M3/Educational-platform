...
urlpatterns = [
    ...
    path('<int:pk>/approve/', views.admin_approve_course,
         name='admin_approve_course'),
    path('<int:pk>/reject/', views.admin_reject_course,
    ...
    path('pending/', views.list_pending_courses, name='list_pending_courses'),
    ...
    path('<int:pk>/complete/', views.mark_course_completed,
    ...
    path('<int:course_id>/reviews/list/',
         views.get_course_reviews, name='get_course_reviews'),
    ...
    # Notes
    path('<int:course_id>/notes/list/',
         views.get_course_notes, name='get_course_notes'),
    ...
    path('<int:pk>/videos/create/', views.create_course_video,
         name='create_course_video'),
    path('videos/<int:video_id>/', views.update_delete_video,
         name='update_delete_video'),
    path('<int:course_id>/recommend/',
         views.recommend_courses, name='recommend-courses'),
    path('recommend/', views.recommend_for_user, name='recommend_for_user'),

    path('<int:pk>/create_payment_intent/',
         views.create_payment_intent, name='create-payment-intent'),
