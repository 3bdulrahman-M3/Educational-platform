...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            ...
            "expiry": int(os.getenv('WEBSOCKET_TIMEOUT', 3600)),
            "group_expiry": 86400,  # Group expiry time in seconds
            "channel_capacity": {
                "http.request": 100,
                "http.response!*": 100,
                "websocket.send!*": 100,
...
# Connection limits
MAX_CONNECTIONS_PER_SESSION = int(os.getenv('MAX_CONNECTIONS_PER_SESSION', 50))
MAX_MESSAGES_PER_MINUTE = int(os.getenv('MAX_MESSAGES_PER_MINUTE', 100))
...
TURN_SERVER = {
    'url': os.getenv('TURN_SERVER_URL', 'turn:your-turn-server.com:3478'),
    'username': os.getenv('TURN_SERVER_USERNAME', 'username'),
    'credential': os.getenv('TURN_SERVER_CREDENTIAL', 'password'),
}
