...
DATABASES = {
    'default': dj_database_url.parse(
        "postgresql://postgres:AScTPTBiplVvNSqewkAUwYohCZfVuhIM@shortline.proxy.rlwy.net:14803/railway"
    )
}
...
# Backward compatibility for older Django/Cloudinary versions
