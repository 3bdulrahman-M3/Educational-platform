...
class SessionCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Session
        fields = ['id', 'title', 'description', 'subject', 'level', 'date', 'duration',
                  'max_participants', 'recording_enabled', 'chat_enabled', 'screen_sharing_enabled', 'room_id']
    ...
    def create(self, validated_data):
        ...
        # Refresh the session to ensure all fields are loaded
